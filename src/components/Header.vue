  ...
  <div class="header">
    <div class="menu">
      <form class="d-flex search">
        <input class="form-control ms-4 mt-3" type="search" placeholder="Nhập từ khóa tìm kiếm" aria-label="Search" v-model="search">
      </form>
      ...
      <div>
        ...
        <div class="button register">
          <router-link v-if="!loggedInUser" :to="`/register`" class="link">Đăng ký</router-link>
        </div>
